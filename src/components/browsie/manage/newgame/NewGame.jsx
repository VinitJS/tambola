...
const NewGame = ({ createGame, name, id, gameLoading, gVersion, counting }) => {
    ...
    return (
        <button disabled={gameLoading || counting} className="btn btn-o mtm" onClick={handleReset}>Restart Game</button>
    );
}
...
const mapDispatchToProps = dispatch => (
    {
        createGame: (name, id, gVer) => dispatch(createGame(name, id, gVer))
    }
);
